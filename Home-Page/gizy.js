...
const dataGizi = {
  laki: {
    "6-11": {
      ...
      lemak: 35,
      protein: 15,
      info: "Usia MPASI awal. Fokus pada pengenalan tekstur makanan dan energi untuk merangkak/belajar berdiri. Lemak tinggi untuk perkembangan otak.",
    },
    "1-3": {
      kalori: 1350,
      karbo: 55,
      lemak: 30,
      protein: 15,
      info: "Anak sangat aktif bergerak, belajar jalan & bicara. Butuh energi stabil dari karbohidrat dan protein untuk pertumbuhan otot.",
    },
    "4-6": {
      kalori: 1400,
      karbo: 55,
      lemak: 25,
      protein: 20,
      info: "Masa prasekolah. Energi untuk bermain dan sosialisasi. Kebutuhan protein meningkat untuk daya tahan tubuh dan pertumbuhan tulang.",
    },
  },
  perempuan: {
    "6-11": {
      ...
      lemak: 35,
      protein: 15,
      info: "Usia MPASI awal. Pertumbuhan fisik cepat. Membutuhkan zat besi tinggi dari protein hewani dan lemak sehat.",
    },
    "1-3": {
      kalori: 1200,
      karbo: 55,
      lemak: 30,
      protein: 15,
      info: "Aktif bermain dan bereksplorasi. Lemak sehat mendukung kecerdasan, karbohidrat sebagai bahan bakar utamanya.",
    },
    "4-6": {
      kalori: 1300,
      karbo: 55,
      lemak: 25,
      protein: 20,
      info: "Persiapan sekolah. Kebutuhan gizi seimbang untuk konsentrasi belajar dan aktivitas fisik yang semakin beragam.",
    },
  },
};
...
function updatePapaDiagram() {
  ...
  document.getElementById("legenda-protein").innerText =
    dataPilihan.protein + "%";
